...
import br.com.cotiinformatica.responses.ServicosGetResponse;
...
public class ServicosController {
	...
	public ResponseEntity<List<ServicosGetResponse>> get() {

		try {
			
			List<ServicosGetResponse> lista = new ArrayList<ServicosGetResponse>();
			
			for(Servico servico : servicoRepository.findAll()) {
				
				ServicosGetResponse servicoResponse = new ServicosGetResponse();
