...
public class JwtConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable()
				...
				.antMatchers(HttpMethod.POST, "/api/profissionais").permitAll()
				.antMatchers(HttpMethod.PUT, "/api/profissionais").permitAll()
				.antMatchers(HttpMethod.DELETE, "/api/profissionais").permitAll()
